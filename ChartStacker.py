...
import glob, os, sys, datetime, locale, math, ctypes, numpy as np
...
def load_files(path):
    ...
    files_this.sort()
    print("\n".join(files_this))
    files_all = ["Datei wählen ..."] + files_this
...
class NewGUI():
    def __init__(self):
        ...
        self.root.title(GUI_NAME + " (" + GUI_VERSION + ")")
